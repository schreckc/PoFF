...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed May 17 08:36:10 2017
# Project:  poff_no_graph.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile poff_no_graph.pro
#############################################################################
...
CXXFLAGS      = -m64 -pipe -g -O2 -std=c++11 -D__MODE_DEBUG=3 -D_REENTRANT -fopenmp -DNO_GRAPHICS_ -O2 -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -lgomp -fopenmp -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: poff_no_graph.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
