...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Thu Mar 23 09:52:53 2017
# Project:  poff.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/poff1.0.0/ && $(COPY_FILE) --parents src/BoxObstacle.hpp src/Camera.hpp src/CameraObject.hpp src/CameraPerso.hpp src/Cube.hpp src/DataFile.hpp src/error.hpp src/ExceptionSimu.hpp src/Grid.hpp src/Input.hpp src/mpm_conf.hpp src/Object.hpp src/Obstacle.hpp src/Particule.hpp src/PlaneObstacle.hpp src/Scene.hpp src/sceneLoader.hpp src/Shader.hpp src/Simulation.hpp src/Sphere.hpp src/SphereObstacle.hpp src/Texture.hpp src/Times.hpp src/common.h obj/poff1.0.0/ && $(COPY_FILE) --parents src/BoxObstacle.cpp src/Camera.cpp src/CameraObject.cpp src/CameraPerso.cpp src/Cube.cpp src/DataFile.cpp src/error.cpp src/Grid.cpp src/Input.cpp src/main.cpp src/mpm_conf.cpp src/Object.cpp src/Obstacle.cpp src/Particule.cpp src/PlaneObstacle.cpp src/Scene.cpp src/Shader.cpp src/Simulation.cpp src/Sphere.cpp src/SphereObstacle.cpp src/Texture.cpp src/Times.cpp obj/poff1.0.0/ && (cd `dirname obj/poff1.0.0` && $(TAR) poff1.0.0.tar poff1.0.0 && $(COMPRESS) poff1.0.0.tar) && $(MOVE) `dirname obj/poff1.0.0`/poff1.0.0.tar.gz . && $(DEL_FILE) -r obj/poff1.0.0
