...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed Feb 22 08:13:28 2017
# Project:  test.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/local/lib -Wl,-rpath,/usr/local/lib -Wl,--enable-new-dtags -lSDL2 -lGL -lSDL2_image -lgomp -fopenmp -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/test1.0.0/ && $(COPY_FILE) --parents src/BoxObstacle.hpp src/Camera.hpp src/CameraObject.hpp src/CameraPerso.hpp src/Cube.hpp src/DataFile.hpp src/error.hpp src/ExceptionSimu.hpp src/Grid.hpp src/Input.hpp src/mpm_conf.hpp src/Object.hpp src/Obstacle.hpp src/Particule.hpp src/PlaneObstacle.hpp src/Scene.hpp src/Shader.hpp src/Simulation.hpp src/Sphere.hpp src/SphereObstacle.hpp src/Texture.hpp src/Times.hpp src/*h obj/test1.0.0/ && $(COPY_FILE) --parents src/BoxObstacle.cpp src/Camera.cpp src/CameraObject.cpp src/CameraPerso.cpp src/Cube.cpp src/DataFile.cpp src/error.cpp src/Grid.cpp src/Input.cpp src/main.cpp src/mpm_conf.cpp src/Object.cpp src/Obstacle.cpp src/Particule.cpp src/PlaneObstacle.cpp src/Scene.cpp src/Shader.cpp src/Simulation.cpp src/Sphere.cpp src/SphereObstacle.cpp src/Texture.cpp src/Times.cpp obj/test1.0.0/ && (cd `dirname obj/test1.0.0` && $(TAR) test1.0.0.tar test1.0.0 && $(COMPRESS) test1.0.0.tar) && $(MOVE) `dirname obj/test1.0.0`/test1.0.0.tar.gz . && $(DEL_FILE) -r obj/test1.0.0
