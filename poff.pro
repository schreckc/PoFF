...
#QT *= xml opengl
QMAKE_CXXFLAGS += -g -O2 -std=c++11  -D__MODE_DEBUG=3 -D_REENTRANT -I/usr/local/include/SDL2 -DHAVE_OPENGLES3 -DHAVE_OPENGL -g -I../external/glfw-3.1.2/include/GLFW -fopenmp $(CFLAGS)
